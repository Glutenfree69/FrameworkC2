//! Syscall execution via indirect syscalls
//!
//! Ce module contient le code assembleur x64 pour exécuter des syscalls
//! de manière indirecte (jump vers ntdll au lieu d'exécuter syscall directement).
...
// Stub pour compilation sur non-x86_64 (pour que cargo check fonctionne sur macOS ARM)
#[cfg(not(target_arch = "x86_64"))]
pub unsafe fn do_syscall(_ssn: u16, _syscall_addr: u64, _n_args: u32) -> i32 {
    panic!("Syscalls only supported on x86_64 Windows")
}
